...
from dynamite_nsm.commandline.utilities.suricata import install, process, logs
from dynamite_nsm.commandline.utilities.suricata.logs import get_interfaces
