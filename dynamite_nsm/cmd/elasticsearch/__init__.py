...
def get_action_parser():
    ...
    append_interface_to_parser(subparsers, 'install', interface=install.interface, interface_group_name='interface')
    append_interface_to_parser(subparsers, 'uninstall', interface=uninstall.interface, interface_group_name='interface')
    append_interface_to_parser(subparsers, 'process', interface=process.interface, interface_group_name='interface')
