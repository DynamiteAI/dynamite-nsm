```bash
usage: [-h] [--configuration-directory CONFIGURATION_DIRECTORY] [--install-directory INSTALL_DIRECTORY] [--download-zeek-archive] [--stdout] [--verbose] [--capture-network-interfaces CAPTURE_NETWORK_INTERFACES [CAPTURE_NETWORK_INTERFACES ...]]

Zeek - Install Zeek as a standalone component.
