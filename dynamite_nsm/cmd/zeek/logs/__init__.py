...
def get_action_parser():
    ...
    append_interface_to_parser(subparsers, 'broker', broker.interface, interface_group_name='sub_interface')
    append_interface_to_parser(subparsers, 'cluster', cluster.interface, interface_group_name='sub_interface')
    append_interface_to_parser(subparsers, 'metrics', metrics.interface, interface_group_name='sub_interface')
    append_interface_to_parser(subparsers, 'reporter', reporter.interface, interface_group_name='sub_interface')
    return parser
