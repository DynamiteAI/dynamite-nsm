...
from dynamite_nsm.cmd.logstash.config import get_action_parser as get_config_action_parser
...
if __name__ == '__main__':
    ...
    res = None
    try:
        res = process_arguments(args, component='logstash', interface=args.interface,
