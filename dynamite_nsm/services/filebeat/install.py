...
def install_filebeat(install_directory, monitor_paths, agent_tag, download_filebeat_archive=True, stdout=True):
    ...
    filebeat_installer = InstallManager(install_directory, monitor_paths, agent_tag,
