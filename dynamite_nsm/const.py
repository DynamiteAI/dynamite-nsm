DEFAULT_CONFIGS_URL = 'https://dynamite-config-staging.s3-us-west-2.amazonaws.com/dynamite-public/0.63/default_configs.tar.gz'
MIRRORS_CONFIG_URL = 'https://dynamite-config-staging.s3-us-west-2.amazonaws.com/dynamite-public/0.63/mirrors.tar.gz'

DEFAULT_CONFIGS_ARCHIVE_NAME = 'default_configs.tar.gz'
MIRRORS_CONFIG_ARCHIVE_NAME = 'mirrors.tar.gz'

DYNAMITE_SDK_ARCHIVE_NAME = 'dynamite-sdk-lite-0.1.1.tar.gz'
...
KIBANA_ARCHIVE_NAME = 'kibana-7.2.1-linux-x86_64.tar.gz'
...
DYNAMITE_SDK_DIRECTORY_NAME = 'dynamite-sdk-lite-0.1.1'
...
KIBANA_DIRECTORY_NAME = 'kibana-7.2.1-linux-x86_64'
