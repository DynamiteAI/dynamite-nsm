...
from dynamite_nsm.agent_api.blueprints.admin.plugins import plugins_blueprint
...
from dynamite_nsm.agent_api.resources.filebeat_profile import api as filebeat_profile_api
